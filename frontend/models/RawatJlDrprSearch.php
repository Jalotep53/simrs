...
/**
 * RawatJlDrprSearch represents the model behind the search form of `frontend\models\RawatJlDrpr`.
 */
class RawatJlDrprSearch extends RawatJlDrpr
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'kd_jenis_prw', 'kd_dokter', 'nip', 'tgl_perawatan', 'jam_rawat', 'stts_bayar'], 'safe'],
