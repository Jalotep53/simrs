...
/**
 * PenilaianMedisRalanParuSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanParu`.
 */
class PenilaianMedisRalanParuSearch extends PenilaianMedisRalanParu
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'keluhan_utama', 'rps', 'rpd', 'rpo', 'alergi', 'kesadaran', 'status', 'td', 'nadi', 'suhu', 'rr', 'bb', 'nyeri', 'gcs', 'kepala', 'thoraks', 'abdomen', 'muskulos', 'lainnya', 'ket_lokalis', 'lab', 'rad', 'pemeriksaan', 'diagnosis', 'diagnosis2', 'permasalahan', 'terapi', 'tindakan', 'edukasi'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianMedisRalanParu::find();
