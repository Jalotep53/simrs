...
/**
 * IpsrsopnameSearch represents the model behind the search form of `frontend\models\Ipsrsopname`.
 */
class IpsrsopnameSearch extends Ipsrsopname
{
    /**
     * {@inheritdoc}
     */
