...
/**
 * PenilaianMedisRalanOrthopediSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanOrthopedi`.
 */
class PenilaianMedisRalanOrthopediSearch extends PenilaianMedisRalanOrthopedi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PenilaianMedisRalanOrthopedi::find();
