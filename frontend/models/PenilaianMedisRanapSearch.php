...
/**
 * PenilaianMedisRanapSearch represents the model behind the search form of `frontend\models\PenilaianMedisRanap`.
 */
class PenilaianMedisRanapSearch extends PenilaianMedisRanap
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'keluhan_utama', 'rps', 'rpd', 'rpk', 'rpo', 'alergi', 'keadaan', 'gcs', 'kesadaran', 'td', 'nadi', 'rr', 'suhu', 'spo', 'bb', 'tb', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'jantung', 'paru', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'ket_lokalis', 'lab', 'rad', 'penunjang', 'diagnosis', 'tata', 'edukasi'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianMedisRanap::find();
