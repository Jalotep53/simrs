...
/**
 * This is the model class for table "pcare_kunjungan_umum".
 *
 ...
 */
class PcareKunjunganUmum extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'lingkarPerut', 'status', 'KdAlergiMakanan', 'NmAlergiMakanan', 'KdAlergiUdara', 'NmAlergiUdara', 'KdAlergiObat', 'NmAlergiObat', 'KdPrognosa', 'NmPrognosa', 'terapi_non_obat', 'bmhp'], 'required'],
            ...
            [['kdPoli', 'kdSadar', 'beratBadan', 'tinggiBadan', 'lingkarPerut', 'kdStatusPulang', 'KdAlergiMakanan', 'KdAlergiUdara', 'KdAlergiObat', 'KdPrognosa'], 'string', 'max' => 5],
            [['nmPoli', 'nmSadar', 'nmStatusPulang', 'nmDokter', 'NmAlergiMakanan', 'NmAlergiUdara', 'NmAlergiObat'], 'string', 'max' => 50],
            [['keluhan', 'nmDiag1', 'nmDiag2', 'nmDiag3'], 'string', 'max' => 400],
