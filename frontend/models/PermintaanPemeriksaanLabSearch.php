...
/**
 * PermintaanPemeriksaanLabSearch represents the model behind the search form of `frontend\models\PermintaanPemeriksaanLab`.
 */
class PermintaanPemeriksaanLabSearch extends PermintaanPemeriksaanLab
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PermintaanPemeriksaanLab::find();
