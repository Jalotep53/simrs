...
/**
 * JadwalPegawaiSearch represents the model behind the search form of `frontend\models\JadwalPegawai`.
 */
class JadwalPegawaiSearch extends JadwalPegawai
{
    /**
     * {@inheritdoc}
     */
