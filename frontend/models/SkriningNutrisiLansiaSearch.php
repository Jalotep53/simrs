...
/**
 * SkriningNutrisiLansiaSearch represents the model behind the search form of `frontend\models\SkriningNutrisiLansia`.
 */
class SkriningNutrisiLansiaSearch extends SkriningNutrisiLansia
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'td', 'hr', 'rr', 'suhu', 'bb', 'tbpb', 'spo2', 'alergi', 'sg1', 'nilai1', 'sg2', 'nilai2', 'sg3', 'nilai3', 'sg4', 'nilai4', 'sg5', 'nilai5', 'sg6', 'nilai6', 'skor_nutrisi', 'nip'], 'safe'],
            [['total_hasil'], 'integer'],
        ];
    }
    ...
    {
        $query = SkriningNutrisiLansia::find();
        ...
        $query->andFilterWhere(['like', 'no_rawat', $this->no_rawat])
            ...
            ->andFilterWhere(['like', 'sg5', $this->sg5])
            ->andFilterWhere(['like', 'nilai5', $this->nilai5])
            ->andFilterWhere(['like', 'sg6', $this->sg6])
            ->andFilterWhere(['like', 'nilai6', $this->nilai6])
