...
/**
 * PcareRujukKhususSearch represents the model behind the search form of `frontend\models\PcareRujukKhusus`.
 */
class PcareRujukKhususSearch extends PcareRujukKhusus
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'noKunjungan', 'tglDaftar', 'no_rkm_medis', 'nm_pasien', 'noKartu', 'kdPoli', 'nmPoli', 'keluhan', 'kdSadar', 'nmSadar', 'sistole', 'diastole', 'beratBadan', 'tinggiBadan', 'respRate', 'heartRate', 'terapi', 'kdStatusPulang', 'nmStatusPulang', 'tglPulang', 'kdDokter', 'nmDokter', 'kdDiag1', 'nmDiag1', 'kdDiag2', 'nmDiag2', 'kdDiag3', 'nmDiag3', 'tglEstRujuk', 'kdPPK', 'kdKhusus', 'nmKhusus', 'kdSubSpesialis', 'nmSubSpesialis', 'catatan', 'kdTACC', 'nmTACC', 'alasanTACC', 'KdAlergiMakanan', 'NmAlergiMakanan', 'KdAlergiUdara', 'NmAlergiUdara', 'KdAlergiObat', 'NmAlergiObat', 'KdPrognosa', 'NmPrognosa', 'terapi_non_obat', 'bmhp'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'no_rawat', $this->no_rawat])
            ...
            ->andFilterWhere(['like', 'kdKhusus', $this->kdKhusus])
            ->andFilterWhere(['like', 'nmKhusus', $this->nmKhusus])
