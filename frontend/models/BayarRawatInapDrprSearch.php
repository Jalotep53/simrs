...
/**
 * BayarRawatInapDrprSearch represents the model behind the search form of `frontend\models\BayarRawatInapDrpr`.
 */
class BayarRawatInapDrprSearch extends BayarRawatInapDrpr
{
    /**
     * {@inheritdoc}
     */
