 ...
 */
class CatatanObservasiInduksiPersalinan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'cairan', 'nip'], 'required'],
            [['tgl_perawatan', 'jam_rawat'], 'safe'],
            [['no_rawat'], 'string', 'max' => 17],
            [['obat', 'cairan', 'his', 'keterangan'], 'string', 'max' => 50],
            [['dosis'], 'string', 'max' => 10],
            [['djj'], 'string', 'max' => 5],
            [['nip'], 'string', 'max' => 20],
