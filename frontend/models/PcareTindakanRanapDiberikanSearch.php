...
/**
 * PcareTindakanRanapDiberikanSearch represents the model behind the search form of `frontend\models\PcareTindakanRanapDiberikan`.
 */
class PcareTindakanRanapDiberikanSearch extends PcareTindakanRanapDiberikan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PcareTindakanRanapDiberikan::find();
