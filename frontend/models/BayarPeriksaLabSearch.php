...
/**
 * BayarPeriksaLabSearch represents the model behind the search form of `frontend\models\BayarPeriksaLab`.
 */
class BayarPeriksaLabSearch extends BayarPeriksaLab
{
    /**
     * {@inheritdoc}
     */
