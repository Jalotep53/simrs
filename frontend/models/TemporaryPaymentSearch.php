...
/**
 * TemporaryPaymentSearch represents the model behind the search form of `frontend\models\TemporaryPayment`.
 */
class TemporaryPaymentSearch extends TemporaryPayment
{
    /**
     * {@inheritdoc}
     */
