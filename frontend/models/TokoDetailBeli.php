...
/**
 * This is the model class for table "toko_detail_beli".
 *
 ...
 * @property Tokopembelian $noFaktur
 */
class TokoDetailBeli extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_faktur', 'kode_sat', 'jumlah', 'harga', 'subtotal', 'dis', 'besardis', 'total'], 'required'],
            [['jumlah', 'harga', 'subtotal', 'dis', 'besardis', 'total'], 'number'],
            [['no_faktur'], 'string', 'max' => 20],
            [['kode_brng'], 'string', 'max' => 40],
            [['kode_sat'], 'string', 'max' => 4],
            [['no_faktur'], 'exist', 'skipOnError' => true, 'targetClass' => Tokopembelian::class, 'targetAttribute' => ['no_faktur' => 'no_faktur']],
    ...
    {
        return $this->hasOne(Tokopembelian::class, ['no_faktur' => 'no_faktur']);
    }
}
