...
/**
 * SatuSehatDiagnosticreportLabSearch represents the model behind the search form of `frontend\models\SatuSehatDiagnosticreportLab`.
 */
class SatuSehatDiagnosticreportLabSearch extends SatuSehatDiagnosticreportLab
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatDiagnosticreportLab::find();
