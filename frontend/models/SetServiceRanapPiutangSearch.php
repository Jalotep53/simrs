...
/**
 * SetServiceRanapPiutangSearch represents the model behind the search form of `frontend\models\SetServiceRanapPiutang`.
 */
class SetServiceRanapPiutangSearch extends SetServiceRanapPiutang
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SetServiceRanapPiutang::find();
