...
/**
 * This is the model class for table "penilaian_medis_ranap_kandungan".
 *
 ...
 */
class PenilaianMedisRanapKandungan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'rps', 'rpk', 'rpo', 'keadaan', 'gcs', 'kesadaran', 'rr', 'spo', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'jantung', 'paru', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'tfu', 'tbj', 'his', 'kontraksi', 'djj', 'inspeksi', 'inspekulo', 'vt', 'rt', 'ultra', 'kardio', 'lab', 'diagnosis', 'tata', 'edukasi'], 'required'],
            [['tanggal'], 'safe'],
            [['anamnesis', 'keadaan', 'kesadaran', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'jantung', 'paru', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'kontraksi', 'inspeksi', 'inspekulo', 'vt', 'rt', 'ultra', 'kardio', 'lab', 'tata'], 'string'],
