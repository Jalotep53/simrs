...
/**
 * This is the model class for table "pcare_rujuk_internal".
 *
 ...
 * @property string|null $nmPoliRujukInternal
 ...
 */
class PcareRujukInternal extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'lingkarPerut', 'KdAlergiMakanan', 'NmAlergiMakanan', 'KdAlergiUdara', 'NmAlergiUdara', 'KdAlergiObat', 'NmAlergiObat', 'KdPrognosa', 'NmPrognosa', 'terapi_non_obat', 'bmhp'], 'required'],
            [['tglDaftar', 'tglPulang'], 'safe'],
            [['no_rawat'], 'string', 'max' => 17],
            [['noKunjungan', 'nm_pasien'], 'string', 'max' => 40],
            [['no_rkm_medis'], 'string', 'max' => 15],
            [['noKartu'], 'string', 'max' => 25],
            [['kdPoli', 'kdSadar', 'beratBadan', 'tinggiBadan', 'lingkarPerut', 'kdStatusPulang', 'kdPoliRujukInternal', 'kdTACC', 'KdAlergiMakanan', 'KdAlergiUdara', 'KdAlergiObat', 'KdPrognosa'], 'string', 'max' => 5],
            [['nmPoli', 'nmSadar', 'nmStatusPulang', 'nmDokter', 'nmPoliRujukInternal', 'nmTACC', 'NmAlergiMakanan', 'NmAlergiUdara', 'NmAlergiObat'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kdDiag3' => 'Kd Diag3',
            'nmDiag3' => 'Nm Diag3',
            'kdPoliRujukInternal' => 'Kd Poli Rujuk Internal',
            'nmPoliRujukInternal' => 'Nm Poli Rujuk Internal',
            'kdTACC' => 'Kd Tacc',
            'nmTACC' => 'Nm Tacc',
