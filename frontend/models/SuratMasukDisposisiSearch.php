...
/**
 * SuratMasukDisposisiSearch represents the model behind the search form of `frontend\models\SuratMasukDisposisi`.
 */
class SuratMasukDisposisiSearch extends SuratMasukDisposisi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SuratMasukDisposisi::find();
