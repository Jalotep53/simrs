...
/**
 * MasterRencanaKeperawatanIgdSearch represents the model behind the search form of `frontend\models\MasterRencanaKeperawatanIgd`.
 */
class MasterRencanaKeperawatanIgdSearch extends MasterRencanaKeperawatanIgd
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterRencanaKeperawatanIgd::find();
