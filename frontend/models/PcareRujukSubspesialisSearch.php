...
/**
 * PcareRujukSubspesialisSearch represents the model behind the search form of `frontend\models\PcareRujukSubspesialis`.
 */
class PcareRujukSubspesialisSearch extends PcareRujukSubspesialis
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'noKunjungan', 'tglDaftar', 'no_rkm_medis', 'nm_pasien', 'noKartu', 'kdPoli', 'nmPoli', 'keluhan', 'kdSadar', 'nmSadar', 'sistole', 'diastole', 'beratBadan', 'tinggiBadan', 'respRate', 'heartRate', 'lingkarPerut', 'terapi', 'kdStatusPulang', 'nmStatusPulang', 'tglPulang', 'kdDokter', 'nmDokter', 'kdDiag1', 'nmDiag1', 'kdDiag2', 'nmDiag2', 'kdDiag3', 'nmDiag3', 'tglEstRujuk', 'kdPPK', 'nmPPK', 'kdSubSpesialis', 'nmSubSpesialis', 'kdSarana', 'nmSarana', 'kdTACC', 'nmTACC', 'alasanTACC', 'KdAlergiMakanan', 'NmAlergiMakanan', 'KdAlergiUdara', 'NmAlergiUdara', 'KdAlergiObat', 'NmAlergiObat', 'KdPrognosa', 'NmPrognosa', 'terapi_non_obat', 'bmhp'], 'safe'],
        ];
    }
    ...
    {
        $query = PcareRujukSubspesialis::find();
        ...
        $query->andFilterWhere(['like', 'no_rawat', $this->no_rawat])
            ...
            ->andFilterWhere(['like', 'nmPPK', $this->nmPPK])
            ->andFilterWhere(['like', 'kdSubSpesialis', $this->kdSubSpesialis])
            ->andFilterWhere(['like', 'nmSubSpesialis', $this->nmSubSpesialis])
            ->andFilterWhere(['like', 'kdSarana', $this->kdSarana])
            ->andFilterWhere(['like', 'nmSarana', $this->nmSarana])
            ->andFilterWhere(['like', 'kdTACC', $this->kdTACC])
            ->andFilterWhere(['like', 'nmTACC', $this->nmTACC])
