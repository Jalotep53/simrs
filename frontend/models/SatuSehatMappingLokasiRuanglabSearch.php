...
/**
 * SatuSehatMappingLokasiRuanglabSearch represents the model behind the search form of `frontend\models\SatuSehatMappingLokasiRuanglab`.
 */
class SatuSehatMappingLokasiRuanglabSearch extends SatuSehatMappingLokasiRuanglab
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatMappingLokasiRuanglab::find();
