...
/**
 * This is the model class for table "penilaian_medis_ralan_anak".
 *
 ...
 */
class PenilaianMedisRalanAnak extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'rps', 'rpk', 'rpo', 'keadaan', 'gcs', 'kesadaran', 'rr', 'spo', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'ket_lokalis', 'penunjang', 'diagnosis', 'tata', 'konsul'], 'required'],
            [['tanggal'], 'safe'],
            [['anamnesis', 'keadaan', 'kesadaran', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'ket_lokalis', 'penunjang', 'tata'], 'string'],
