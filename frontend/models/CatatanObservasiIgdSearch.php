...
/**
 * CatatanObservasiIgdSearch represents the model behind the search form of `frontend\models\CatatanObservasiIgd`.
 */
class CatatanObservasiIgdSearch extends CatatanObservasiIgd
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = CatatanObservasiIgd::find();
