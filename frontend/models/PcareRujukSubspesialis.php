...
/**
 * This is the model class for table "pcare_rujuk_subspesialis".
 *
 ...
 * @property string $nmPPK
 * @property string|null $kdSubSpesialis
 * @property string|null $nmSubSpesialis
 * @property string|null $kdSarana
 * @property string|null $nmSarana
 ...
 */
class PcareRujukSubspesialis extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pcare_rujuk_subspesialis';
    }
    ...
    {
        return [
            [['no_rawat', 'lingkarPerut', 'nmPPK', 'KdAlergiMakanan', 'NmAlergiMakanan', 'KdAlergiUdara', 'NmAlergiUdara', 'KdAlergiObat', 'NmAlergiObat', 'KdPrognosa', 'NmPrognosa', 'terapi_non_obat', 'bmhp'], 'required'],
            ...
            [['kdPoli', 'kdSadar', 'beratBadan', 'tinggiBadan', 'lingkarPerut', 'kdStatusPulang', 'kdSubSpesialis', 'kdSarana', 'kdTACC', 'KdAlergiMakanan', 'KdAlergiUdara', 'KdAlergiObat', 'KdPrognosa'], 'string', 'max' => 5],
            [['nmPoli', 'nmSadar', 'nmStatusPulang', 'nmDokter', 'nmSubSpesialis', 'nmSarana', 'nmTACC', 'NmAlergiMakanan', 'NmAlergiUdara', 'NmAlergiObat'], 'string', 'max' => 50],
            ...
            [['nmPPK', 'NmPrognosa'], 'string', 'max' => 100],
            [['no_rawat'], 'unique'],
