...
/**
 * InventarisPembelianSearch represents the model behind the search form of `frontend\models\InventarisPembelian`.
 */
class InventarisPembelianSearch extends InventarisPembelian
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_faktur', 'kode_suplier', 'nip', 'tgl_beli', 'kd_rek', 'kd_rek_aset'], 'safe'],
    ...
    {
        $query = InventarisPembelian::find();
