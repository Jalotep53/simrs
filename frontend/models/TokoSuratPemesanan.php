...
/**
 * This is the model class for table "toko_surat_pemesanan".
 *
 ...
 */
class TokoSuratPemesanan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(TokoDetailSuratPemesanan::class, ['no_pemesanan' => 'no_pemesanan']);
    }
}
