...
/**
 * ResepLuarRacikanDetailSearch represents the model behind the search form of `frontend\models\ResepLuarRacikanDetail`.
 */
class ResepLuarRacikanDetailSearch extends ResepLuarRacikanDetail
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ResepLuarRacikanDetail::find();
