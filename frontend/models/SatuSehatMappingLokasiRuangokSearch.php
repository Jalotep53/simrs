...
/**
 * SatuSehatMappingLokasiRuangokSearch represents the model behind the search form of `frontend\models\SatuSehatMappingLokasiRuangok`.
 */
class SatuSehatMappingLokasiRuangokSearch extends SatuSehatMappingLokasiRuangok
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatMappingLokasiRuangok::find();
