...
/**
 * This is the model class for table "pcare_tindakan_ranap_diberikan".
 *
 ...
 *
 * @property MapingTindakanRanapPcare $kdJenisPrw
 * @property RegPeriksa $noRawat
 */
class PcareTindakanRanapDiberikan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pcare_tindakan_ranap_diberikan';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['kd_jenis_prw'], 'exist', 'skipOnError' => true, 'targetClass' => MapingTindakanRanapPcare::class, 'targetAttribute' => ['kd_jenis_prw' => 'kd_jenis_prw']],
        ];
    }
