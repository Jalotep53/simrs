...
/**
 * DapurbarangSearch represents the model behind the search form of `frontend\models\Dapurbarang`.
 */
class DapurbarangSearch extends Dapurbarang
{
    /**
     * {@inheritdoc}
     */
