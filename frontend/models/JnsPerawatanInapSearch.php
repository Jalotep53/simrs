...
/**
 * JnsPerawatanInapSearch represents the model behind the search form of `frontend\models\JnsPerawatanInap`.
 */
class JnsPerawatanInapSearch extends JnsPerawatanInap
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['kd_jenis_prw', 'nm_perawatan', 'kd_kategori', 'kd_pj', 'kd_bangsal', 'status', 'kelas'], 'safe'],
