...
/**
 * MatrikAkunJnsPerawatanSearch represents the model behind the search form of `frontend\models\MatrikAkunJnsPerawatan`.
 */
class MatrikAkunJnsPerawatanSearch extends MatrikAkunJnsPerawatan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MatrikAkunJnsPerawatan::find();
