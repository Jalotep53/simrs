...
/**
 * KeslingLimbahB3medisCairSearch represents the model behind the search form of `frontend\models\KeslingLimbahB3medisCair`.
 */
class KeslingLimbahB3medisCairSearch extends KeslingLimbahB3medisCair
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = KeslingLimbahB3medisCair::find();
