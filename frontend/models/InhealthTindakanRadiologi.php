...
/**
 * This is the model class for table "inhealth_tindakan_radiologi".
 *
 ...
 */
class InhealthTindakanRadiologi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'inhealth_tindakan_radiologi';
    }
