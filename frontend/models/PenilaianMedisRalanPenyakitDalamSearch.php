...
/**
 * PenilaianMedisRalanPenyakitDalamSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanPenyakitDalam`.
 */
class PenilaianMedisRalanPenyakitDalamSearch extends PenilaianMedisRalanPenyakitDalam
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PenilaianMedisRalanPenyakitDalam::find();
        ...
        $query->andFilterWhere(['like', 'no_rawat', $this->no_rawat])
            ...
            ->andFilterWhere(['like', 'keterangan_thorak', $this->keterangan_thorak])
            ...
            ->andFilterWhere(['like', 'penunjanglain', $this->penunjanglain])
