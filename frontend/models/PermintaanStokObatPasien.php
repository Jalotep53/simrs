...
/**
 * This is the model class for table "permintaan_stok_obat_pasien".
 *
 ...
 */
class PermintaanStokObatPasien extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'permintaan_stok_obat_pasien';
    }
    ...
    {
        return $this->hasMany(DetailPermintaanStokObatPasien::class, ['no_permintaan' => 'no_permintaan']);
    }
