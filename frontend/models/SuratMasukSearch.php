...
/**
 * SuratMasukSearch represents the model behind the search form of `frontend\models\SuratMasuk`.
 */
class SuratMasukSearch extends SuratMasuk
{
    ...
    {
        return [
            [['no_urut', 'no_surat', 'asal', 'tujuan', 'tgl_surat', 'perihal', 'tgl_terima', 'kd_lemari', 'kd_rak', 'kd_map', 'kd_ruang', 'kd_sifat', 'lampiran', 'tembusan', 'tgl_deadline_balas', 'kd_balas', 'keterangan', 'kd_status', 'kd_klasifikasi', 'file_url'], 'safe'],
        ];
    }
