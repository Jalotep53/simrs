...
/**
 * This is the model class for table "bayar_operasi_operator3".
 *
 ...
 */
class BayarOperasiOperator3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_operator3';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biayaoperator3'], 'required'],
            [['tgl_operasi'], 'safe'],
