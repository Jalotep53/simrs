...
/**
 * SatuSehatServicerequestLabMbSearch represents the model behind the search form of `frontend\models\SatuSehatServicerequestLabMb`.
 */
class SatuSehatServicerequestLabMbSearch extends SatuSehatServicerequestLabMb
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatServicerequestLabMb::find();
