...
/**
 * IpsrsreturbeliSearch represents the model behind the search form of `frontend\models\Ipsrsreturbeli`.
 */
class IpsrsreturbeliSearch extends Ipsrsreturbeli
{
    /**
     * {@inheritdoc}
     */
