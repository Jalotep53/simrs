...
/**
 * TemporaryGiziSearch represents the model behind the search form of `frontend\models\TemporaryGizi`.
 */
class TemporaryGiziSearch extends TemporaryGizi
{
    /**
     * {@inheritdoc}
     */
