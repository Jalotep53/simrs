...
/**
 * DetailhibahObatBhpSearch represents the model behind the search form of `frontend\models\DetailhibahObatBhp`.
 */
class DetailhibahObatBhpSearch extends DetailhibahObatBhp
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_hibah', 'kode_brng', 'kode_sat', 'no_batch', 'kadaluarsa'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'h_diakui' => $this->h_diakui,
            'subtotaldiakui' => $this->subtotaldiakui,
