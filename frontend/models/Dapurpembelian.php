...
/**
 * This is the model class for table "dapurpembelian".
 *
 ...
 * @property Dapursuplier $kodeSuplier
 * @property Petugas $nip0
 */
class Dapurpembelian extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['kode_suplier'], 'exist', 'skipOnError' => true, 'targetClass' => Dapursuplier::class, 'targetAttribute' => ['kode_suplier' => 'kode_suplier']],
        ];
    }
    ...
    {
        return $this->hasMany(Dapurdetailbeli::class, ['no_faktur' => 'no_faktur']);
    }
    ...
    {
        return $this->hasOne(Dapursuplier::class, ['kode_suplier' => 'kode_suplier']);
    }
