...
/**
 * PemeriksaanObstetriRalanSearch represents the model behind the search form of `frontend\models\PemeriksaanObstetriRalan`.
 */
class PemeriksaanObstetriRalanSearch extends PemeriksaanObstetriRalan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PemeriksaanObstetriRalan::find();
