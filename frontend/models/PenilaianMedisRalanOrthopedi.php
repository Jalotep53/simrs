...
/**
 * This is the model class for table "penilaian_medis_ralan_orthopedi".
 *
 ...
 */
class PenilaianMedisRalanOrthopedi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'rps', 'rpo', 'kesadaran', 'status', 'suhu', 'bb', 'gcs', 'kepala', 'thoraks', 'abdomen', 'ekstremitas', 'genetalia', 'columna', 'muskulos', 'lainnya', 'ket_lokalis', 'lab', 'rad', 'pemeriksaan', 'diagnosis', 'diagnosis2', 'permasalahan', 'terapi', 'tindakan', 'edukasi'], 'required'],
            [['tanggal'], 'safe'],
            [['anamnesis', 'kesadaran', 'kepala', 'thoraks', 'abdomen', 'ekstremitas', 'genetalia', 'columna', 'muskulos', 'ket_lokalis'], 'string'],
            [['no_rawat'], 'string', 'max' => 17],
            [['kd_dokter'], 'string', 'max' => 20],
            [['hubungan'], 'string', 'max' => 30],
            [['keluhan_utama', 'rps'], 'string', 'max' => 2000],
            [['rpd', 'rpo', 'lainnya'], 'string', 'max' => 1000],
            [['alergi', 'status'], 'string', 'max' => 50],
            [['td'], 'string', 'max' => 8],
            [['nadi', 'suhu', 'rr', 'bb', 'nyeri'], 'string', 'max' => 5],
            [['gcs'], 'string', 'max' => 10],
