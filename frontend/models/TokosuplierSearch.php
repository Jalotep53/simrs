...
/**
 * TokosuplierSearch represents the model behind the search form of `frontend\models\Tokosuplier`.
 */
class TokosuplierSearch extends Tokosuplier
{
    /**
     * {@inheritdoc}
     */
