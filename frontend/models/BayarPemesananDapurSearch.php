...
/**
 * BayarPemesananDapurSearch represents the model behind the search form of `frontend\models\BayarPemesananDapur`.
 */
class BayarPemesananDapurSearch extends BayarPemesananDapur
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BayarPemesananDapur::find();
