...
/**
 * IpsrspembelianSearch represents the model behind the search form of `frontend\models\Ipsrspembelian`.
 */
class IpsrspembelianSearch extends Ipsrspembelian
{
    /**
     * {@inheritdoc}
     */
