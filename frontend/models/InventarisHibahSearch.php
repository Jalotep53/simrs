...
/**
 * InventarisHibahSearch represents the model behind the search form of `frontend\models\InventarisHibah`.
 */
class InventarisHibahSearch extends InventarisHibah
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_hibah', 'kode_pemberi', 'nip', 'tgl_hibah', 'kd_rek_aset'], 'safe'],
            [['totalhibah'], 'number'],
        ];
    }
