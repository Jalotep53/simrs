...
/**
 * MasterRencanaKeperawatanNeonatusSearch represents the model behind the search form of `frontend\models\MasterRencanaKeperawatanNeonatus`.
 */
class MasterRencanaKeperawatanNeonatusSearch extends MasterRencanaKeperawatanNeonatus
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterRencanaKeperawatanNeonatus::find();
