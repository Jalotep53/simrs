...
/**
 * PenilaianMedisRalanKandunganSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanKandungan`.
 */
class PenilaianMedisRalanKandunganSearch extends PenilaianMedisRalanKandungan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'keluhan_utama', 'rps', 'rpd', 'rpk', 'rpo', 'alergi', 'keadaan', 'gcs', 'kesadaran', 'td', 'nadi', 'rr', 'suhu', 'spo', 'bb', 'tb', 'kepala', 'mata', 'gigi', 'tht', 'thoraks', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'tfu', 'tbj', 'his', 'kontraksi', 'djj', 'inspeksi', 'inspekulo', 'vt', 'rt', 'ultra', 'kardio', 'lab', 'diagnosis', 'tata', 'konsul'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianMedisRalanKandungan::find();
