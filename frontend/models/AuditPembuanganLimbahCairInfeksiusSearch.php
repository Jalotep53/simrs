...
/**
 * AuditPembuanganLimbahCairInfeksiusSearch represents the model behind the search form of `frontend\models\AuditPembuanganLimbahCairInfeksius`.
 */
class AuditPembuanganLimbahCairInfeksiusSearch extends AuditPembuanganLimbahCairInfeksius
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AuditPembuanganLimbahCairInfeksius::find();
