...
/**
 * This is the model class for table "bayar_operasi_dokter_anak".
 *
 ...
 */
class BayarOperasiDokterAnak extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_dokter_anak';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biayadokter_anak'], 'required'],
            [['tgl_operasi'], 'safe'],
            [['biayadokter_anak'], 'number'],
