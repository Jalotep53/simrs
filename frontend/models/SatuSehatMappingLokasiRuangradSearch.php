...
/**
 * SatuSehatMappingLokasiRuangradSearch represents the model behind the search form of `frontend\models\SatuSehatMappingLokasiRuangrad`.
 */
class SatuSehatMappingLokasiRuangradSearch extends SatuSehatMappingLokasiRuangrad
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatMappingLokasiRuangrad::find();
