...
/**
 * This is the model class for table "bayar_detail_periksa_lab".
 *
 ...
 */
class BayarDetailPeriksaLab extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_detail_periksa_lab';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kd_jenis_prw', 'tgl_periksa', 'jam', 'id_template', 'bagian_dokter'], 'required'],
