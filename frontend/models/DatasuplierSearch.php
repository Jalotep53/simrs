...
/**
 * DatasuplierSearch represents the model behind the search form of `frontend\models\Datasuplier`.
 */
class DatasuplierSearch extends Datasuplier
{
    /**
     * {@inheritdoc}
     */
