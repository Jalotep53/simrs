...
/**
 * TemporaryTokoSearch represents the model behind the search form of `frontend\models\TemporaryToko`.
 */
class TemporaryTokoSearch extends TemporaryToko
{
    /**
     * {@inheritdoc}
     */
