...
/**
 * MasterRencanaKeperawatanSearch represents the model behind the search form of `frontend\models\MasterRencanaKeperawatan`.
 */
class MasterRencanaKeperawatanSearch extends MasterRencanaKeperawatan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterRencanaKeperawatan::find();
