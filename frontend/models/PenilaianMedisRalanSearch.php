...
/**
 * PenilaianMedisRalanSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalan`.
 */
class PenilaianMedisRalanSearch extends PenilaianMedisRalan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'keluhan_utama', 'rps', 'rpd', 'rpk', 'rpo', 'alergi', 'keadaan', 'gcs', 'kesadaran', 'td', 'nadi', 'rr', 'suhu', 'spo', 'bb', 'tb', 'kepala', 'gigi', 'tht', 'thoraks', 'abdomen', 'genital', 'ekstremitas', 'kulit', 'ket_fisik', 'ket_lokalis', 'penunjang', 'diagnosis', 'tata', 'konsulrujuk'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianMedisRalan::find();
