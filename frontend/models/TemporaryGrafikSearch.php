...
/**
 * TemporaryGrafikSearch represents the model behind the search form of `frontend\models\TemporaryGrafik`.
 */
class TemporaryGrafikSearch extends TemporaryGrafik
{
    /**
     * {@inheritdoc}
     */
