...
/**
 * SkorStewardPascaAnestesiSearch represents the model behind the search form of `frontend\models\SkorStewardPascaAnestesi`.
 */
class SkorStewardPascaAnestesiSearch extends SkorStewardPascaAnestesi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'penilaian_skala1', 'penilaian_skala2', 'penilaian_skala3', 'keluar', 'instruksi', 'kd_dokter', 'nip'], 'safe'],
    ...
    {
        $query = SkorStewardPascaAnestesi::find();
