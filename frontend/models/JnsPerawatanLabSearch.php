...
/**
 * JnsPerawatanLabSearch represents the model behind the search form of `frontend\models\JnsPerawatanLab`.
 */
class JnsPerawatanLabSearch extends JnsPerawatanLab
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['kd_jenis_prw', 'nm_perawatan', 'kd_pj', 'status', 'kelas', 'kategori'], 'safe'],
