...
/**
 * This is the model class for table "temporary_lama_pelayanan_radiologi".
 *
 * @property int $no
 ...
 */
class TemporaryLamaPelayananRadiologi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'temporary_lama_pelayanan_radiologi';
    }
