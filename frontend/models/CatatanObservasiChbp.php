...
/**
 * This is the model class for table "catatan_observasi_chbp".
 *
 ...
 */
class CatatanObservasiChbp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'td', 'djj', 'his', 'ppv', 'keterangan', 'nip'], 'required'],
            [['tgl_perawatan', 'jam_rawat'], 'safe'],
            [['no_rawat'], 'string', 'max' => 17],
            [['td'], 'string', 'max' => 8],
            [['hr', 'suhu', 'djj'], 'string', 'max' => 5],
            [['his', 'nip'], 'string', 'max' => 20],
            [['ppv'], 'string', 'max' => 10],
