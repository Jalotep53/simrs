...
/**
 * This is the model class for table "bayar_operasi_dokter_umum".
 *
 * @property string $no_bayar
 * @property string $no_rawat
 * @property string $kode_paket
 * @property string $tgl_operasi
 * @property float $biaya_dokter_umum
 *
 * @property PaketOperasi $kodePaket
 * @property BayarJmDokter $noBayar
 * @property RegPeriksa $noRawat
 */
class BayarOperasiDokterUmum extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_dokter_umum';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biaya_dokter_umum'], 'required'],
            [['tgl_operasi'], 'safe'],
