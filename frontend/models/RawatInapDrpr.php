...
/**
 * This is the model class for table "rawat_inap_drpr".
 *
 ...
 */
class RawatInapDrpr extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'kd_jenis_prw', 'kd_dokter', 'nip', 'tgl_perawatan', 'jam_rawat', 'material', 'bhp'], 'required'],
