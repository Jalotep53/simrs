...
/**
 * InventarisSuplierSearch represents the model behind the search form of `frontend\models\InventarisSuplier`.
 */
class InventarisSuplierSearch extends InventarisSuplier
{
    /**
     * {@inheritdoc}
     */
