...
/**
 * PermintaanLabmbSearch represents the model behind the search form of `frontend\models\PermintaanLabmb`.
 */
class PermintaanLabmbSearch extends PermintaanLabmb
{
    /**
     * {@inheritdoc}
     */
