...
/**
 * BiayaSekaliSearch represents the model behind the search form of `frontend\models\BiayaSekali`.
 */
class BiayaSekaliSearch extends BiayaSekali
{
    /**
     * {@inheritdoc}
     */
