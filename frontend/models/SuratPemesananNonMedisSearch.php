...
/**
 * SuratPemesananNonMedisSearch represents the model behind the search form of `frontend\models\SuratPemesananNonMedis`.
 */
class SuratPemesananNonMedisSearch extends SuratPemesananNonMedis
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SuratPemesananNonMedis::find();
