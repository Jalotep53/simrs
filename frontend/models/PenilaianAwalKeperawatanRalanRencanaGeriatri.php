...
/**
 * This is the model class for table "penilaian_awal_keperawatan_ralan_rencana_geriatri".
 *
 * @property string $no_rawat
 * @property string $kode_rencana
 *
 * @property MasterRencanaKeperawatanGeriatri $kodeRencana
 * @property PenilaianAwalKeperawatanRalanGeriatri $noRawat
 */
class PenilaianAwalKeperawatanRalanRencanaGeriatri extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'penilaian_awal_keperawatan_ralan_rencana_geriatri';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['kode_rencana'], 'exist', 'skipOnError' => true, 'targetClass' => MasterRencanaKeperawatanGeriatri::class, 'targetAttribute' => ['kode_rencana' => 'kode_rencana']],
        ];
    }
    ...
    {
        return $this->hasOne(MasterRencanaKeperawatanGeriatri::class, ['kode_rencana' => 'kode_rencana']);
    }
