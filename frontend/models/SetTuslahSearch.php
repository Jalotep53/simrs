...
/**
 * SetTuslahSearch represents the model behind the search form of `frontend\models\SetTuslah`.
 */
class SetTuslahSearch extends SetTuslah
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tahun' => $this->tahun,
            'bulan' => $this->bulan,
            'pendapatan_tuslah' => $this->pendapatan_tuslah,
