...
/**
 * This is the model class for table "audit_sterilisasi_alat".
 *
 ...
 * @property string $audit9
 * @property string $audit10
 * @property string $audit11
 *
 * @property RuangAuditKepatuhan $ruang
 */
class AuditSterilisasiAlat extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['tanggal', 'id_ruang', 'audit9', 'audit10', 'audit11'], 'required'],
            [['tanggal'], 'safe'],
            [['audit1', 'audit2', 'audit3', 'audit4', 'audit5', 'audit6', 'audit7', 'audit8', 'audit9', 'audit10', 'audit11'], 'string'],
