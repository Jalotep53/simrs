...
/**
 * This is the model class for table "bayar_rawat_jl_drpr".
 *
 ...
 */
class BayarRawatJlDrpr extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kd_jenis_prw', 'tgl_perawatan', 'jam_rawat'], 'required'],
