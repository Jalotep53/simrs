...
/**
 * This is the model class for table "pemeriksaan_ralan".
 *
 ...
 */
class PemeriksaanRalan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'tensi', 'spo2', 'kesadaran', 'rtl', 'penilaian', 'instruksi', 'evaluasi', 'nip'], 'required'],
            [['tgl_perawatan', 'jam_rawat'], 'safe'],
            [['kesadaran'], 'string'],
            [['no_rawat'], 'string', 'max' => 17],
            [['suhu_tubuh', 'tinggi', 'berat', 'lingkar_perut'], 'string', 'max' => 5],
            [['tensi'], 'string', 'max' => 8],
            [['nadi', 'respirasi', 'spo2'], 'string', 'max' => 3],
            [['gcs'], 'string', 'max' => 10],
            [['keluhan', 'pemeriksaan', 'rtl', 'penilaian', 'instruksi', 'evaluasi'], 'string', 'max' => 2000],
