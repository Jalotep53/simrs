...
/**
 * This is the model class for table "temporary_permintaan_radiologi".
 *
 * @property int $no
 ...
 */
class TemporaryPermintaanRadiologi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'temporary_permintaan_radiologi';
    }
