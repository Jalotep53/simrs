...
/**
 * This is the model class for table "catatan_observasi_ranap_kebidanan".
 *
 ...
 */
class CatatanObservasiRanapKebidanan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'td', 'spo2', 'kontraksi', 'bjj', 'ppv', 'vt', 'nip'], 'required'],
            [['tgl_perawatan', 'jam_rawat'], 'safe'],
            [['no_rawat'], 'string', 'max' => 17],
            [['gcs'], 'string', 'max' => 10],
            [['td'], 'string', 'max' => 8],
            [['hr', 'rr', 'suhu', 'bjj'], 'string', 'max' => 5],
            [['spo2'], 'string', 'max' => 3],
            [['kontraksi', 'ppv'], 'string', 'max' => 15],
            [['vt'], 'string', 'max' => 30],
            [['nip'], 'string', 'max' => 20],
