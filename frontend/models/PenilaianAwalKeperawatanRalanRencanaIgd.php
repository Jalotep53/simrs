...
/**
 * This is the model class for table "penilaian_awal_keperawatan_ralan_rencana_igd".
 *
 * @property string $no_rawat
 * @property string $kode_rencana
 *
 * @property MasterRencanaKeperawatanIgd $kodeRencana
 * @property PenilaianAwalKeperawatanIgd $noRawat
 */
class PenilaianAwalKeperawatanRalanRencanaIgd extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'penilaian_awal_keperawatan_ralan_rencana_igd';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['kode_rencana'], 'exist', 'skipOnError' => true, 'targetClass' => MasterRencanaKeperawatanIgd::class, 'targetAttribute' => ['kode_rencana' => 'kode_rencana']],
        ];
    }
    ...
    {
        return $this->hasOne(MasterRencanaKeperawatanIgd::class, ['kode_rencana' => 'kode_rencana']);
    }
