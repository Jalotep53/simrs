...
/**
 * This is the model class for table "satu_sehat_clinicalimpression".
 *
 * @property string $no_rawat
 * @property string $tgl_perawatan
 * @property string $jam_rawat
 * @property string $status
 * @property string|null $id_clinicalimpression
 *
 * @property RegPeriksa $noRawat
 */
class SatuSehatClinicalimpression extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['id_clinicalimpression'], 'string', 'max' => 40],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'jam_rawat' => 'Jam Rawat',
            'status' => 'Status',
            'id_clinicalimpression' => 'Id Clinicalimpression',
        ];
    }
