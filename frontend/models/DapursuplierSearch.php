...
/**
 * DapursuplierSearch represents the model behind the search form of `frontend\models\Dapursuplier`.
 */
class DapursuplierSearch extends Dapursuplier
{
    /**
     * {@inheritdoc}
     */
