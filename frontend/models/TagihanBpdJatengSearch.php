...
/**
 * TagihanBpdJatengSearch represents the model behind the search form of `frontend\models\TagihanBpdJateng`.
 */
class TagihanBpdJatengSearch extends TagihanBpdJateng
{
    /**
     * {@inheritdoc}
     */
