...
/**
 * MasterRencanaKeperawatanGeriatriSearch represents the model behind the search form of `frontend\models\MasterRencanaKeperawatanGeriatri`.
 */
class MasterRencanaKeperawatanGeriatriSearch extends MasterRencanaKeperawatanGeriatri
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterRencanaKeperawatanGeriatri::find();
