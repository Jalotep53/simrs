...
/**
 * This is the model class for table "bayar_operasi_dokter_anestesi".
 *
 ...
 */
class BayarOperasiDokterAnestesi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_dokter_anestesi';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biayadokter_anestesi'], 'required'],
            [['tgl_operasi'], 'safe'],
