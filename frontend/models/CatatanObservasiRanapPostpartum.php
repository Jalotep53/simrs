...
/**
 * This is the model class for table "catatan_observasi_ranap_postpartum".
 *
 ...
 */
class CatatanObservasiRanapPostpartum extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'td', 'spo2', 'tfu', 'kontraksi', 'perdarahan', 'keterangan', 'nip'], 'required'],
            ...
            [['spo2'], 'string', 'max' => 3],
            [['tfu', 'kontraksi', 'perdarahan'], 'string', 'max' => 15],
