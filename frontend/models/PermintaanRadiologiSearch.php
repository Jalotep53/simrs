...
/**
 * PermintaanRadiologiSearch represents the model behind the search form of `frontend\models\PermintaanRadiologi`.
 */
class PermintaanRadiologiSearch extends PermintaanRadiologi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PermintaanRadiologi::find();
