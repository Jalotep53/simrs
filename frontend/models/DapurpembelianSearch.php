...
/**
 * DapurpembelianSearch represents the model behind the search form of `frontend\models\Dapurpembelian`.
 */
class DapurpembelianSearch extends Dapurpembelian
{
    /**
     * {@inheritdoc}
     */
