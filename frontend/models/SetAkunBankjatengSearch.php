...
/**
 * SetAkunBankjatengSearch represents the model behind the search form of `frontend\models\SetAkunBankjateng`.
 */
class SetAkunBankjatengSearch extends SetAkunBankjateng
{
    /**
     * {@inheritdoc}
     */
