...
/**
 * BayarOperasiDokterAnestesiSearch represents the model behind the search form of `frontend\models\BayarOperasiDokterAnestesi`.
 */
class BayarOperasiDokterAnestesiSearch extends BayarOperasiDokterAnestesi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BayarOperasiDokterAnestesi::find();
