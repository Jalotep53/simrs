...
/**
 * This is the model class for table "bayar_operasi_operator1".
 *
 ...
 */
class BayarOperasiOperator1 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_operator1';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biayaoperator1'], 'required'],
            [['tgl_operasi'], 'safe'],
