...
/**
 * TemporaryBookingRegistrasiSearch represents the model behind the search form of `frontend\models\TemporaryBookingRegistrasi`.
 */
class TemporaryBookingRegistrasiSearch extends TemporaryBookingRegistrasi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = TemporaryBookingRegistrasi::find();
