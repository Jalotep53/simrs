...
/**
 * ResepDokterRacikanSearch represents the model behind the search form of `frontend\models\ResepDokterRacikan`.
 */
class ResepDokterRacikanSearch extends ResepDokterRacikan
{
    /**
     * {@inheritdoc}
     */
