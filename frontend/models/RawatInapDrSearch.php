...
/**
 * RawatInapDrSearch represents the model behind the search form of `frontend\models\RawatInapDr`.
 */
class RawatInapDrSearch extends RawatInapDr
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'kd_jenis_prw', 'kd_dokter', 'tgl_perawatan', 'jam_rawat'], 'safe'],
