...
/**
 * ChecklistKriteriaKeluarIcuSearch represents the model behind the search form of `frontend\models\ChecklistKriteriaKeluarIcu`.
 */
class ChecklistKriteriaKeluarIcuSearch extends ChecklistKriteriaKeluarIcu
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kriteria1', 'kriteria2', 'kriteria3', 'kriteria4', 'kriteria5', 'kriteria6', 'kriteria7', 'kriteria8', 'kriteria9', 'kriteria10', 'kriteria11', 'nik'], 'safe'],
        ];
    }
    ...
    {
        $query = ChecklistKriteriaKeluarIcu::find();
