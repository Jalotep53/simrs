...
/**
 * SatuSehatDiagnosticreportLabMbSearch represents the model behind the search form of `frontend\models\SatuSehatDiagnosticreportLabMb`.
 */
class SatuSehatDiagnosticreportLabMbSearch extends SatuSehatDiagnosticreportLabMb
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SatuSehatDiagnosticreportLabMb::find();
