...
/**
 * PenilaianMedisRalanKulitdankelaminSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanKulitdankelamin`.
 */
class PenilaianMedisRalanKulitdankelaminSearch extends PenilaianMedisRalanKulitdankelamin
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kd_dokter', 'anamnesis', 'hubungan', 'keluhan_utama', 'rps', 'rpd', 'rpo', 'rpk', 'kesadaran', 'status', 'td', 'nadi', 'suhu', 'rr', 'bb', 'nyeri', 'gcs', 'statusderma', 'pemeriksaan', 'diagnosis', 'diagnosis2', 'permasalahan', 'terapi', 'tindakan', 'edukasi'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianMedisRalanKulitdankelamin::find();
        ...
        $query->andFilterWhere(['like', 'no_rawat', $this->no_rawat])
            ...
            ->andFilterWhere(['like', 'statusderma', $this->statusderma])
