...
/**
 * BayarOperasiDokterAnakSearch represents the model behind the search form of `frontend\models\BayarOperasiDokterAnak`.
 */
class BayarOperasiDokterAnakSearch extends BayarOperasiDokterAnak
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BayarOperasiDokterAnak::find();
