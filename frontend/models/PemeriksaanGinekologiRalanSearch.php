...
/**
 * PemeriksaanGinekologiRalanSearch represents the model behind the search form of `frontend\models\PemeriksaanGinekologiRalan`.
 */
class PemeriksaanGinekologiRalanSearch extends PemeriksaanGinekologiRalan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PemeriksaanGinekologiRalan::find();
