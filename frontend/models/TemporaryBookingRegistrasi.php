...
/**
 * This is the model class for table "temporary_booking_registrasi".
 *
 * @property int $no
 ...
 */
class TemporaryBookingRegistrasi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'temporary_booking_registrasi';
    }
