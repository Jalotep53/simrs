...
/**
 * This is the model class for table "bayar_periksa_radiologi_perujuk".
 *
 ...
 */
class BayarPeriksaRadiologiPerujuk extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_periksa_radiologi_perujuk';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kd_jenis_prw', 'tgl_periksa', 'jam', 'tarif_perujuk'], 'required'],
