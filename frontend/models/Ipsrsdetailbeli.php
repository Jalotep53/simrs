...
/**
 * This is the model class for table "ipsrsdetailbeli".
 *
 ...
 * @property Ipsrspembelian $noFaktur
 */
class Ipsrsdetailbeli extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['no_faktur'], 'exist', 'skipOnError' => true, 'targetClass' => Ipsrspembelian::class, 'targetAttribute' => ['no_faktur' => 'no_faktur']],
    ...
    {
        return $this->hasOne(Ipsrspembelian::class, ['no_faktur' => 'no_faktur']);
    }
}
