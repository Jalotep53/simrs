...
/**
 * This is the model class for table "bayar_operasi_dokter_pjanak".
 *
 * @property string $no_bayar
 * @property string $no_rawat
 * @property string $kode_paket
 * @property string $tgl_operasi
 * @property float $biaya_dokter_pjanak
 *
 * @property PaketOperasi $kodePaket
 * @property BayarJmDokter $noBayar
 * @property RegPeriksa $noRawat
 */
class BayarOperasiDokterPjanak extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bayar_operasi_dokter_pjanak';
    }
    ...
    {
        return [
            [['no_bayar', 'no_rawat', 'kode_paket', 'tgl_operasi', 'biaya_dokter_pjanak'], 'required'],
            [['tgl_operasi'], 'safe'],
