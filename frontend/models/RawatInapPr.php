...
/**
 * This is the model class for table "rawat_inap_pr".
 *
 ...
 */
class RawatInapPr extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'kd_jenis_prw', 'nip', 'tgl_perawatan', 'jam_rawat', 'material', 'bhp', 'tarif_tindakanpr'], 'required'],
            [['tgl_perawatan', 'jam_rawat'], 'safe'],
            [['material', 'bhp', 'tarif_tindakanpr', 'kso', 'menejemen', 'biaya_rawat'], 'number'],
            [['no_rawat'], 'string', 'max' => 17],
            [['kd_jenis_prw'], 'string', 'max' => 15],
            [['nip'], 'string', 'max' => 20],
            [['no_rawat', 'kd_jenis_prw', 'nip', 'tgl_perawatan', 'jam_rawat'], 'unique', 'targetAttribute' => ['no_rawat', 'kd_jenis_prw', 'nip', 'tgl_perawatan', 'jam_rawat']],
