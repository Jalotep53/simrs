...
/**
 * PenilaianMedisRalanNeurologiSearch represents the model behind the search form of `frontend\models\PenilaianMedisRalanNeurologi`.
 */
class PenilaianMedisRalanNeurologiSearch extends PenilaianMedisRalanNeurologi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PenilaianMedisRalanNeurologi::find();
