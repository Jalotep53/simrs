...
/**
 * This is the model class for table "checklist_kriteria_keluar_icu".
 *
 ...
 */
class ChecklistKriteriaKeluarIcu extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tanggal', 'kriteria1', 'kriteria2', 'kriteria3', 'kriteria4', 'kriteria5', 'kriteria6', 'kriteria7', 'kriteria8', 'kriteria9', 'kriteria10', 'kriteria11'], 'required'],
            [['tanggal'], 'safe'],
            [['kriteria1', 'kriteria2', 'kriteria3', 'kriteria4', 'kriteria5', 'kriteria6', 'kriteria7', 'kriteria8', 'kriteria9', 'kriteria10', 'kriteria11'], 'string'],
