...
/**
 * TemporaryResumeSearch represents the model behind the search form of `frontend\models\TemporaryResume`.
 */
class TemporaryResumeSearch extends TemporaryResume
{
    /**
     * {@inheritdoc}
     */
