...
/**
 * BayarRawatJlDrSearch represents the model behind the search form of `frontend\models\BayarRawatJlDr`.
 */
class BayarRawatJlDrSearch extends BayarRawatJlDr
{
    /**
     * {@inheritdoc}
     */
