...
/**
 * This is the model class for table "bayar_pemesanan_dapur".
 *
 ...
 * @property Dapurpemesanan $noFaktur
 */
class BayarPemesananDapur extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['no_faktur'], 'exist', 'skipOnError' => true, 'targetClass' => Dapurpemesanan::class, 'targetAttribute' => ['no_faktur' => 'no_faktur']],
    ...
    {
        return $this->hasOne(Dapurpemesanan::class, ['no_faktur' => 'no_faktur']);
    }
}
