...
/**
 * TagihanBpdJabarSearch represents the model behind the search form of `frontend\models\TagihanBpdJabar`.
 */
class TagihanBpdJabarSearch extends TagihanBpdJabar
{
    /**
     * {@inheritdoc}
     */
