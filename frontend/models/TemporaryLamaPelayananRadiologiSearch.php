...
/**
 * TemporaryLamaPelayananRadiologiSearch represents the model behind the search form of `frontend\models\TemporaryLamaPelayananRadiologi`.
 */
class TemporaryLamaPelayananRadiologiSearch extends TemporaryLamaPelayananRadiologi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = TemporaryLamaPelayananRadiologi::find();
