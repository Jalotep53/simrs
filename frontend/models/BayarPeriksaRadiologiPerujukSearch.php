...
/**
 * BayarPeriksaRadiologiPerujukSearch represents the model behind the search form of `frontend\models\BayarPeriksaRadiologiPerujuk`.
 */
class BayarPeriksaRadiologiPerujukSearch extends BayarPeriksaRadiologiPerujuk
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BayarPeriksaRadiologiPerujuk::find();
