...
/**
 * This is the model class for table "surat_pulang_atas_permintaan_sendiri_saksi_keluarga".
 *
 ...
 */
class SuratPulangAtasPermintaanSendiriSaksiKeluarga extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'surat_pulang_atas_permintaan_sendiri_saksi_keluarga';
    }
