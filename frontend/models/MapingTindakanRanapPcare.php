...
/**
 * This is the model class for table "maping_tindakan_ranap_pcare".
 *
 ...
 */
class MapingTindakanRanapPcare extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'maping_tindakan_ranap_pcare';
    }
    ...
    {
        return $this->hasMany(PcareTindakanRanapDiberikan::class, ['kd_jenis_prw' => 'kd_jenis_prw']);
    }
}
