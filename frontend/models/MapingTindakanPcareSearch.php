...
/**
 * MapingTindakanPcareSearch represents the model behind the search form of `frontend\models\MapingTindakanPcare`.
 */
class MapingTindakanPcareSearch extends MapingTindakanPcare
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MapingTindakanPcare::find();
