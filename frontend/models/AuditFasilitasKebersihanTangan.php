...
/**
 * This is the model class for table "audit_fasilitas_kebersihan_tangan".
 *
 ...
 */
class AuditFasilitasKebersihanTangan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'audit_fasilitas_kebersihan_tangan';
    }
    ...
    {
        return [
            [['tanggal', 'id_ruang', 'audit9'], 'required'],
            [['tanggal'], 'safe'],
