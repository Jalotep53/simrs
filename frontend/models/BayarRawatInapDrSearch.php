...
/**
 * BayarRawatInapDrSearch represents the model behind the search form of `frontend\models\BayarRawatInapDr`.
 */
class BayarRawatInapDrSearch extends BayarRawatInapDr
{
    /**
     * {@inheritdoc}
     */
