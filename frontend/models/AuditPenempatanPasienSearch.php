...
/**
 * AuditPenempatanPasienSearch represents the model behind the search form of `frontend\models\AuditPenempatanPasien`.
 */
class AuditPenempatanPasienSearch extends AuditPenempatanPasien
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AuditPenempatanPasien::find();
