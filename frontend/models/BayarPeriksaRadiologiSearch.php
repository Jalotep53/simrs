...
/**
 * BayarPeriksaRadiologiSearch represents the model behind the search form of `frontend\models\BayarPeriksaRadiologi`.
 */
class BayarPeriksaRadiologiSearch extends BayarPeriksaRadiologi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BayarPeriksaRadiologi::find();
