...
/**
 * IpsrspemesananSearch represents the model behind the search form of `frontend\models\Ipsrspemesanan`.
 */
class IpsrspemesananSearch extends Ipsrspemesanan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_faktur', 'no_order', 'kode_suplier', 'nip', 'tgl_pesan', 'tgl_faktur', 'tgl_tempo', 'status'], 'safe'],
