...
/**
 * MasterRencanaKeperawatanPsikiatriSearch represents the model behind the search form of `frontend\models\MasterRencanaKeperawatanPsikiatri`.
 */
class MasterRencanaKeperawatanPsikiatriSearch extends MasterRencanaKeperawatanPsikiatri
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterRencanaKeperawatanPsikiatri::find();
