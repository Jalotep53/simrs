...
/**
 * This is the model class for table "kategori_pengeluaran_harian".
 *
 ...
 */
class KategoriPengeluaranHarian extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'kategori_pengeluaran_harian';
    }
    ...
    {
        return $this->hasMany(PengeluaranHarian::class, ['kode_kategori' => 'kode_kategori']);
    }
}
