...
/**
 * This is the model class for table "surat_ruang".
 *
 * @property string $kd
 ...
 */
class SuratRuang extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(SuratKeluar::class, ['kd_ruang' => 'kd']);
    }
    ...
    {
        return $this->hasMany(SuratMasuk::class, ['kd_ruang' => 'kd']);
    }
}
