...
/**
 * CatatanObservasiRanapSearch represents the model behind the search form of `frontend\models\CatatanObservasiRanap`.
 */
class CatatanObservasiRanapSearch extends CatatanObservasiRanap
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['no_rawat', 'tgl_perawatan', 'jam_rawat', 'gcs', 'td', 'hr', 'rr', 'suhu', 'spo2', 'nip'], 'safe'],
        ];
    }
    ...
    {
        $query = CatatanObservasiRanap::find();
