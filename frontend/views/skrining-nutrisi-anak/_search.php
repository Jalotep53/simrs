...
/** @var frontend\models\SkriningNutrisiAnakSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="skrining-nutrisi-anak-search">
    ...
    <?php // echo $form->field($model, 'diketahui_dietisien') ?>

    <?php // echo $form->field($model, 'keterangan_diketahui_dietisien') ?>
