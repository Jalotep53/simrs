...
/** @var frontend\models\PcareRujukKhususSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="pcare-rujuk-khusus-search">
    ...
    <?php // echo $form->field($model, 'kdKhusus') ?>

    <?php // echo $form->field($model, 'nmKhusus') ?>
