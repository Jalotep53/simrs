...
/** @var frontend\models\AuditSterilisasiAlatSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="audit-sterilisasi-alat-search">
    ...
    <?php // echo $form->field($model, 'audit9') ?>

    <?php // echo $form->field($model, 'audit10') ?>

    <?php // echo $form->field($model, 'audit11') ?>
