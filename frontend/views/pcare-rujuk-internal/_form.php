...
<div class="pcare-rujuk-internal-form">
    ...
    <?= $form->field($model, 'kdPoliRujukInternal')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nmPoliRujukInternal')->textInput(['maxlength' => true]) ?>
