...
<div class="pcare-rujuk-subspesialis-form">
    ...
    <?= $form->field($model, 'tglEstRujuk')->textInput() ?>

    <?= $form->field($model, 'kdPPK')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nmPPK')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kdSubSpesialis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nmSubSpesialis')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kdSarana')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nmSarana')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kdTACC')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nmTACC')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'alasanTACC')->textInput(['maxlength' => true]) ?>
