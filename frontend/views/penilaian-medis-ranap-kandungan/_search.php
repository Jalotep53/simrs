...
/** @var frontend\models\PenilaianMedisRanapKandunganSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="penilaian-medis-ranap-kandungan-search">
    ...
    <?php // echo $form->field($model, 'jantung') ?>
    ...
    <?php // echo $form->field($model, 'inspekulo') ?>

    <?php // echo $form->field($model, 'vt') ?>

    <?php // echo $form->field($model, 'rt') ?>

    <?php // echo $form->field($model, 'ultra') ?>

    <?php // echo $form->field($model, 'kardio') ?>
