...
/** @var frontend\models\TagihanMandiriSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="tagihan-mandiri-search">
    ...
    <?php // echo $form->field($model, 'dibatalkan_oleh') ?>

    <?php // echo $form->field($model, 'besar_batal') ?>

    <?php // echo $form->field($model, 'kasir') ?>

    <?php // echo $form->field($model, 'tambahan1') ?>

    <?php // echo $form->field($model, 'tambahan2') ?>

    <?php // echo $form->field($model, 'tambahan3') ?>
