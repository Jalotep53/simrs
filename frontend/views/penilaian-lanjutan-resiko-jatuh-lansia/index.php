...
/** @var frontend\models\PenilaianLanjutanResikoJatuhLansiaSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Penilaian Lanjutan Resiko Jatuh Lansias';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="penilaian-lanjutan-resiko-jatuh-lansia-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Penilaian Lanjutan Resiko Jatuh Lansia', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, PenilaianLanjutanResikoJatuhLansia $model, $key, $index, $column) {
