...
/** @var frontend\models\PenilaianMedisRalanPenyakitDalamSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="penilaian-medis-ralan-penyakit-dalam-search">
    ...
    <?php // echo $form->field($model, 'keterangan_thorak') ?>
    ...
    <?php // echo $form->field($model, 'penunjanglain') ?>
