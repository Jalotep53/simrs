...
<div class="penilaian-medis-ralan-orthopedi-form">
    ...
    <?= $form->field($model, 'genetalia')->dropDownList([ 'Normal' => 'Normal', 'Abnormal' => 'Abnormal', 'Tidak Diperiksa' => 'Tidak Diperiksa', ], ['prompt' => '']) ?>
