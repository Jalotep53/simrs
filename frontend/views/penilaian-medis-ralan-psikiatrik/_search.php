...
/** @var frontend\models\PenilaianMedisRalanPsikiatrikSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="penilaian-medis-ralan-psikiatrik-search">
    ...
    <?php // echo $form->field($model, 'penampilan') ?>

    <?php // echo $form->field($model, 'pembicaraan') ?>

    <?php // echo $form->field($model, 'psikomotor') ?>

    <?php // echo $form->field($model, 'sikap') ?>

    <?php // echo $form->field($model, 'mood') ?>

    <?php // echo $form->field($model, 'fungsi_kognitif') ?>

    <?php // echo $form->field($model, 'gangguan_persepsi') ?>

    <?php // echo $form->field($model, 'proses_pikir') ?>

    <?php // echo $form->field($model, 'pengendalian_impuls') ?>

    <?php // echo $form->field($model, 'tilikan') ?>

    <?php // echo $form->field($model, 'rta') ?>
    ...
    <?php // echo $form->field($model, 'konsulrujuk') ?>
