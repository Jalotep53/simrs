...
use frontend\models\PeriksaLabSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PeriksaLabController implements the CRUD actions for PeriksaLab model.
 */
class PeriksaLabController extends Controller
{
    ...
    /**
     * Lists all PeriksaLab models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new PeriksaLabSearch();
    ...
    /**
     * Displays a single PeriksaLab model.
    ...
    /**
     * Creates a new PeriksaLab model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new PeriksaLab();
    ...
    /**
     * Updates an existing PeriksaLab model.
    ...
    /**
     * Deletes an existing PeriksaLab model.
    ...
    /**
     * Finds the PeriksaLab model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $no_rawat No Rawat
     * @param string $kd_jenis_prw Kd Jenis Prw
     * @param string $tgl_periksa Tgl Periksa
     * @param string $jam Jam
     * @return PeriksaLab the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_rawat, $kd_jenis_prw, $tgl_periksa, $jam)
    {
        if (($model = PeriksaLab::findOne(['no_rawat' => $no_rawat, 'kd_jenis_prw' => $kd_jenis_prw, 'tgl_periksa' => $tgl_periksa, 'jam' => $jam])) !== null) {
            return $model;
        }
