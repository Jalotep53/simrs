...
use frontend\models\RawatJlDrprSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RawatJlDrprController implements the CRUD actions for RawatJlDrpr model.
 */
class RawatJlDrprController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all RawatJlDrpr models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new RawatJlDrprSearch();
    ...
    /**
     * Displays a single RawatJlDrpr model.
    ...
    /**
     * Creates a new RawatJlDrpr model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new RawatJlDrpr();
    ...
    /**
     * Updates an existing RawatJlDrpr model.
    ...
    /**
     * Deletes an existing RawatJlDrpr model.
    ...
    /**
     * Finds the RawatJlDrpr model based on its primary key value.
     ...
     * @param string $tgl_perawatan Tgl Perawatan
     * @param string $jam_rawat Jam Rawat
     * @return RawatJlDrpr the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_rawat, $kd_jenis_prw, $kd_dokter, $nip, $tgl_perawatan, $jam_rawat)
    {
        if (($model = RawatJlDrpr::findOne(['no_rawat' => $no_rawat, 'kd_jenis_prw' => $kd_jenis_prw, 'kd_dokter' => $kd_dokter, 'nip' => $nip, 'tgl_perawatan' => $tgl_perawatan, 'jam_rawat' => $jam_rawat])) !== null) {
            return $model;
        }
