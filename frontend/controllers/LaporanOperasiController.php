...
use frontend\models\LaporanOperasiSearch;
...
class LaporanOperasiController extends Controller
{
    ...
    {
        $searchModel = new LaporanOperasiSearch();
    ...
    /**
     * Displays a single LaporanOperasi model.
    ...
    /**
     * Creates a new LaporanOperasi model.
    ...
    /**
     * Updates an existing LaporanOperasi model.
    ...
    /**
     * Deletes an existing LaporanOperasi model.
    ...
    {
        if (($model = LaporanOperasi::findOne(['no_rawat' => $no_rawat, 'tanggal' => $tanggal])) !== null) {
            return $model;
        }
