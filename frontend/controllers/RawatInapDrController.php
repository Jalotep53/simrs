...
use frontend\models\RawatInapDrSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RawatInapDrController implements the CRUD actions for RawatInapDr model.
 */
class RawatInapDrController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all RawatInapDr models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new RawatInapDrSearch();
    ...
    /**
     * Displays a single RawatInapDr model.
    ...
    /**
     * Creates a new RawatInapDr model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new RawatInapDr();
    ...
    /**
     * Updates an existing RawatInapDr model.
    ...
    /**
     * Deletes an existing RawatInapDr model.
    ...
    /**
     * Finds the RawatInapDr model based on its primary key value.
     ...
     * @param string $tgl_perawatan Tgl Perawatan
     * @param string $jam_rawat Jam Rawat
     * @return RawatInapDr the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_rawat, $kd_jenis_prw, $kd_dokter, $tgl_perawatan, $jam_rawat)
    {
        if (($model = RawatInapDr::findOne(['no_rawat' => $no_rawat, 'kd_jenis_prw' => $kd_jenis_prw, 'kd_dokter' => $kd_dokter, 'tgl_perawatan' => $tgl_perawatan, 'jam_rawat' => $jam_rawat])) !== null) {
            return $model;
        }
