...
use frontend\models\BayarRawatInapDrpr;
use frontend\models\BayarRawatInapDrprSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BayarRawatInapDrprController implements the CRUD actions for BayarRawatInapDrpr model.
 */
class BayarRawatInapDrprController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all BayarRawatInapDrpr models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new BayarRawatInapDrprSearch();
    ...
    /**
     * Displays a single BayarRawatInapDrpr model.
    ...
    /**
     * Creates a new BayarRawatInapDrpr model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new BayarRawatInapDrpr();
    ...
    /**
     * Updates an existing BayarRawatInapDrpr model.
    ...
    /**
     * Deletes an existing BayarRawatInapDrpr model.
    ...
    /**
     * Finds the BayarRawatInapDrpr model based on its primary key value.
     ...
     * @param string $tgl_perawatan Tgl Perawatan
     * @param string $jam_rawat Jam Rawat
     * @return BayarRawatInapDrpr the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_bayar, $no_rawat, $kd_jenis_prw, $tgl_perawatan, $jam_rawat)
    {
        if (($model = BayarRawatInapDrpr::findOne(['no_bayar' => $no_bayar, 'no_rawat' => $no_rawat, 'kd_jenis_prw' => $kd_jenis_prw, 'tgl_perawatan' => $tgl_perawatan, 'jam_rawat' => $jam_rawat])) !== null) {
            return $model;
        }
