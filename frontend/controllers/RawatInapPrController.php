...
use frontend\models\RawatInapPrSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * RawatInapPrController implements the CRUD actions for RawatInapPr model.
 */
class RawatInapPrController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all RawatInapPr models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new RawatInapPrSearch();
    ...
    /**
     * Displays a single RawatInapPr model.
    ...
    /**
     * Creates a new RawatInapPr model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new RawatInapPr();
    ...
    /**
     * Updates an existing RawatInapPr model.
    ...
    /**
     * Deletes an existing RawatInapPr model.
    ...
    /**
     * Finds the RawatInapPr model based on its primary key value.
     ...
     * @param string $tgl_perawatan Tgl Perawatan
     * @param string $jam_rawat Jam Rawat
     * @return RawatInapPr the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_rawat, $kd_jenis_prw, $nip, $tgl_perawatan, $jam_rawat)
    {
        if (($model = RawatInapPr::findOne(['no_rawat' => $no_rawat, 'kd_jenis_prw' => $kd_jenis_prw, 'nip' => $nip, 'tgl_perawatan' => $tgl_perawatan, 'jam_rawat' => $jam_rawat])) !== null) {
            return $model;
        }
