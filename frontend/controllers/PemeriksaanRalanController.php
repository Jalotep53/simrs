...
use frontend\models\PemeriksaanRalanSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PemeriksaanRalanController implements the CRUD actions for PemeriksaanRalan model.
 */
class PemeriksaanRalanController extends Controller
{
    ...
    /**
     * Lists all PemeriksaanRalan models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new PemeriksaanRalanSearch();
    ...
    /**
     * Displays a single PemeriksaanRalan model.
    ...
    /**
     * Creates a new PemeriksaanRalan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new PemeriksaanRalan();
    ...
    /**
     * Updates an existing PemeriksaanRalan model.
    ...
    /**
     * Deletes an existing PemeriksaanRalan model.
    ...
    /**
     * Finds the PemeriksaanRalan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $no_rawat No Rawat
     * @param string $tgl_perawatan Tgl Perawatan
     * @param string $jam_rawat Jam Rawat
     * @return PemeriksaanRalan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($no_rawat, $tgl_perawatan, $jam_rawat)
    {
        if (($model = PemeriksaanRalan::findOne(['no_rawat' => $no_rawat, 'tgl_perawatan' => $tgl_perawatan, 'jam_rawat' => $jam_rawat])) !== null) {
            return $model;
        }
