...
class KecamatanController extends Controller
{
     ...
     * @param int $kd_kec Kd Kec
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($kd_kec)
    {
        return $this->render('view', [
            'model' => $this->findModel($kd_kec),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'kd_kec' => $model->kd_kec]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($kd_kec)
    {
        $model = $this->findModel($kd_kec);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($kd_kec)
    {
        $this->findModel($kd_kec)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($kd_kec)
    {
        if (($model = Kecamatan::findOne(['kd_kec' => $kd_kec])) !== null) {
            return $model;
        }
